const allRecordsFunction = require("../../testSetups/backlogItemRecords.js").allBacklogItemRecords; 
const databaseClass = require("../../BacklogItem.js").BacklogItem;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const validKeyPrefix = 'BLI';
const numRecords = 2;
const recordClassName = 'BacklogItem';
