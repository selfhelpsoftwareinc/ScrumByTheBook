const allRecordsFunction = require("../../testSetups/bliChangeRecords.js").allBLIChangeRecords; 
const databaseClass = require("../../BLIChange.js").BLIChange;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const validKeyPrefix = 'BLIC';
const numRecords = 4;
const recordClassName = 'BLIChange';
