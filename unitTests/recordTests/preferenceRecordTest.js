const allRecordsFunction = require("../../testSetups/preferenceRecords.js").allPreferenceRecords; 
const databaseClass = require("../../Preference.js").Preference;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const numRecords = 8;
const recordClassName = 'Preference';
