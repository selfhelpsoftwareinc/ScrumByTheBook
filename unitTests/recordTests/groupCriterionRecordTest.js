const allRecordsFunction = require("../../testSetups/groupCriterionRecords.js").allGroupCriterionRecords; 
const databaseClass = require("../../GroupCriterion.js").GroupCriterion;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const numRecords = 5;
const recordClassName = 'GroupCriterion';
...
function testNumberOfColumns(aRecord) {
    ...
    assert.isAtMost(aRecord.columnNames().length, validColumns.length, id)
}
...
function testRecord(record) {
    describe('each ' + recordClassName +' record', function () {
        it('should contain at most ' + validColumns.length + ' columns', function() {
