const allRecordsFunction = require("../../testSetups/cardSortRecords.js").allCardSortRecords; 
const databaseClass = require("../../CardSort.js").CardSort;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const numRecords = 5;
const recordClassName = 'CardSort';
