const allRecordsFunction = require("../../testSetups/assigneeToBLIMappingRecords.js").allAssigneeToBLIMappingRecords; 
const databaseClass = require("../../AssigneeToBLIMapping.js").AssigneeToBLIMapping;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const validKeyPrefix = 'ATBM';
const numRecords = 4;
const recordClassName = 'AssigneeToBLIMapping';
