const allRecordsFunction = require("../../testSetups/sprintToBLIMappingRecords.js").allSprintToBLIMappingRecords; 
const databaseClass = require("../../SprintToBLIMapping.js").SprintToBLIMapping;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const validKeyPrefix = 'STBM';
const numRecords = 3;
const recordClassName = 'SprintToBLIMapping';
