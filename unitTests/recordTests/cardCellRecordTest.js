const allRecordsFunction = require("../../testSetups/cardCellRecords.js").allCardCellRecords; 
const databaseClass = require("../../CardCell.js").CardCell;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const numRecords = 5;
const recordClassName = 'CardCell';
