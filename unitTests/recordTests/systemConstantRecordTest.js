const allRecordsFunction = require("../../testSetups/systemConstantRecords.js").allSystemConstantRecords; 
const databaseClass = require("../../SystemConstant.js").SystemConstant;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const numRecords = 6;
const recordClassName = 'SystemConstant';
