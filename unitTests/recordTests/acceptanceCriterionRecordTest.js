const allRecordsFunction = require("../../testSetups/acceptanceCriterionRecords.js").allAcceptanceCriterionRecords; 
const databaseClass = require("../../AcceptanceCriterion.js").AcceptanceCriterion;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');


const validKeyPrefix = 'AC';
const numRecords = 2;
const recordClassName = 'AcceptanceCriterion';
