const allRecordsFunction = require("../../testSetups/transitionRecords.js").allTransitionRecords; 
const databaseClass = require("../../Transition.js").Transition;
const assert = require('chai').assert;
const logger = require('../../node_modules/mocha-logger');

const numRecords = 33;
const recordClassName = 'Transition';
